    ...
    return (
        <div className="min-h-screen bg-slate-50 font-sans selection:bg-blue-100 selection:text-blue-900">
            ...
            <main className="max-w-5xl mx-auto px-4 sm:px-6 py-10">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto shrink-0">
                        ...
                        >
                            ...
                            <span className="hidden sm:inline">Recibir Progreso por Código</span>
                        </button>
                        <button
                            onClick={onNewStudy}
                ...
                <p className="text-xs text-slate-500 -mt-8 mb-8 text-center md:text-right">
                    Comparte el código de un estudio para que otra persona continúe el progreso exacto.
                </p>
                                ...
                                {studies.map(study => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            {/* Footer Actions */}
                                            <div className="bg-slate-50 p-3 px-4 border-t border-slate-100 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-2">
                                                <div className="flex flex-col items-start gap-1 w-full sm:w-auto">
                                                    <span className="text-[11px] font-semibold text-slate-500 sm:hidden">Código para compartir progreso</span>
                                                    <button
                                                    ...
                                                    >
                                                        ...
                                                        <span className="text-[11px] font-semibold text-brand-primary sm:hidden">Copiar</span>
                                                    </button>
                                                </div>
                                                ...
                                                <div className="w-full sm:w-auto flex items-center gap-2 self-end sm:self-auto">
                                                    <button
                                                        ...
                                                        className="w-full sm:w-auto min-h-10 inline-flex items-center justify-center gap-1.5 px-3 py-2 text-slate-500 hover:text-brand-primary hover:bg-brand-secondary/20 rounded-lg transition-colors border border-slate-200 bg-white"
                                                        title="Exportar JSON"
                                                    >
                                                        <Download className="w-4 h-4" />
                                                        <span className="text-xs font-semibold sm:hidden">Descargar</span>
                                                    </button>
                                                </div>
                                            </div>
                        ...
                        >
                            <div className="bg-brand-primary p-6 text-white relative overflow-hidden">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="text-brand-secondary text-sm mt-1">Ingresa el código de 6 dígitos que te compartieron para continuar ese progreso.</p>
                                </div>
                            </div>
